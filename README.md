This is a OpenRoad app power by [Blitz.js](https://github.com/blitz-js/blitz)
...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/OPR
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/OPR_test
```
